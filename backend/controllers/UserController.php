...
class UserController extends BaseBEController
{
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if($model->update()){
                Yii::$app->session->setFlash('success', 'Cannot update');
                return $this->redirect(['view', 'id' => $model->id]);
            }
            Yii::$app->getSession()->setFlash('error', 'Updated success');
        }
...
//        $model->setScenario('change-password');
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            Yii::$app->session->setFlash('error', 'Error! Cannot update');
            return $this->redirect(['info']);
        }
    }
...
//                    return $this->redirect(['view', 'id' => $model->id]);
//                }
//                Yii::$app->getSession()->setFlash('error', 'Cannot update!');
//            }else{
...
//        return $this->redirect(['index']);
        ...
        Yii::$app->session->setFlash('error', 'Cannot update!');
        return $this->redirect(['index']);
