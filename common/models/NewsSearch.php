...
class NewsSearch extends News
{
    ...
    {
        return [
            [['id', 'status', 'created_at', 'updated_at', 'is_slide', 'category_id', 'posted_id'], 'integer'],
            [['image_display', 'image_slide', 'title', 'description', 'content'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'image_display', $this->image_display])
            ->andFilterWhere(['like', 'image_slide', $this->image_slide])
